...
export class Game {
  ...
  // #region Teams
  private team: Team = new Team('demo', 'Demo')
  ...
  // #region Clients
  private client: TeamClient | null = null
  ...
  sendVoteSessionToClients() {
    ...
    // if (client) {
      this.client?.send('voteSession', session)
    //   return
    // }
  ...
  sendSuspectDatabaseToTeams () {
    ...
    this.client?.send('suspectDatabase', this.suspectDatabaseManager.getDatabase((this.client as TeamClient).teamId))
  }

  sendShownSuspectsToClients () {
    ...
    // if (client) {
    this.client?.send('shownSuspects', shownSuspects)
    //   return
    // }
  ...
  sendCluesToClients() {
    ...
    // if (client) {
    this.client?.send('clues', getCluesObj(this.client))
    //   return
    // }
  ...
  //   this.client?.send('adminClues', clues)
  //   //   return
  //   // }
  ...
  sendFormToTeamClient () {
    ...
    this.client?.send('form', {
      fields: this.formManager.getForm((this.client as TeamClient).teamId),
      submitted: this.formManager.isFormSubmitted((this.client as TeamClient).teamId)
    })
    //   return
    // }
  ...
  sendFormPageToTeamClient () {
    ...
    this.client?.send('formPage', this.formManager.getFormPage((this.client as TeamClient).teamId))
    //   return
    // }
  ...
  sendResultsToBoard () {
    ...
    this.client?.send('results', results)
    //   return
    // }
