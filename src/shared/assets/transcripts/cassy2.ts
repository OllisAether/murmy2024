...
export const cassy2: Transcript =  {
  ...
  content: [
    ...
    ['cassy', textContent(['Äh, was ist daran falsch? Phineas gehört zu mir. Und es ist völlig normal, Dinge aufzunehmen, die man mag. Genauso wie ich Phineas filme, weil er- Weil er einfach ', entry({
      id: 'cassy-phineas-perfekt',
      suspectId: 'cassandra',
      title: 'Phineas ist „perfekt“',
      description: 'Cassandra bezeichnet Phineas als „perfekt“.\n\nWas meint sie damit?'
    ...
    ['cassy', textContent([entry('cassy-phineas-perfekt', 'Er war einfach perfekt.'), ' Perfekt für meine Rituale. ', entry({
      id: 'cassy-phineas-opfer',
      suspectId: 'cassandra',

      title: 'Wollte Phineas opfern',
      description: 'Cassandra wollte Phineas opfern, um ein Ritual durchzuführen.\n\nWas hat es damit auf sich?'
    }, 'Das perfekte Opfer.'), ' Ich musste sicherstellen, dass er unversehrt bleibt. Na ja, jetzt ist er halt tot. Alles war umsonst. Na ja, vielleicht doch nicht ganz umsonst. Ich bin dem Orakel noch nie so nahe gekommen wie jetzt.'])],
    ...
    ['cassy', textContent(['Ich bin ihr direkt gefolgt. ', entry({
      id: 'cassy-tuer-gehangen',
      suspectId: 'cassandra',

      title: 'Hing sich an die Tür',
      description: 'Cassandra hing sich an die Tür des Krankenwagens, um Phineas zu folgen.\n\nDas ist doch absurd, oder?'
    }, 'Ich habe mich an die Tür gehangen'), ', ohne dass es jemand gemerkt hat. Später, als sie dann in seinem Zimmer war, bin ich direkt zugegangen und habe mich neben ihn gesetzt und mit ihm geredet. Er hat zwar nicht geantwortet, aber er kannte meinen Namen. Er wusste, wer es war.'])],
    ['ermittlerin', 'Ich ignoriere mal, dass Sie an der Tür hingen. Worüber haben Sie geredet?'],
    ['cassy', textContent(['Ach, über dies und das. Ich habe ihr ein paar Rituale gezeigt, bei dem ', entry('cassy-phineas-opfer', 'ich ihn gerne opfern wollte.'), ' Er hat zwar nichts gesagt, aber ich hab es in seinen Augen gesehen. Er war begeistert von der Idee. Ich habe Zustimmung in seinen Augen gesehen.'])],
    ['ermittlerin', 'Wie lange sind Sie geblieben?'],
    ['cassy', textContent(['Boah, eine Ewigkeit. Irgendwann hat dann meine Mutter angerufen und ich habe mich auf den Weg gemacht. Auf dem Weg hin habe ich Herr Montague gesehen. Ja. Und dann fiel mir auf, dass ich noch mit Ivy reden wollte. ', entry({
      id: 'cassy-ivy-verraterin',
      suspectId: 'cassandra',

      title: 'Bezeichnet Ivy als Verräterin',
