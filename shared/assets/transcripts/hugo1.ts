...
export const hugo1: Transcript =  {
  ...
  content: [
    ...
    ['hugo', 'Danke.Ich möchte nur, dass derjenige,der meiner Tochterdas Leben genommen hat,schnellstens gefunden wird.Der Tod muss gesühnt werden.'],
    ...
    ['hugo', 'Nach dem Unterricht habe ich noch eine Klausur vorbereitet für mein Oberstufenkurs. Und dann war ich noch Holz holen für den Kamin und draußen etwas frische Luft schnappen. Anschließend hatte ich noch Orchester-AG, was meinen Aufenthalt dann in der Schule verlängerte. Aber es geht doch hier nicht um mich.'],
    ...
    ['hugo', 'Ja, das stimmt, dass- Ich habe sie tot zu Hause gefunden. Das Fenster stand offen und- Jemand- Jemand muss eingebrochen sein. Irgendjemand- Irgendjemand muss sie ermordet haben. Ich-'],
    ...
    ['ermittlerin', 'Verstehe. Ihre Akte zeigt, dass Sie eine kriminelle Vergangenheit haben. Könnte es jemand aus der Vergangenheit geben, der sich revanchieren wollte bei Ihnen?'],
    ['hugo', 'Nein. Meine Frau Elena war mein Fels in der Brandung. Sie hat alles für mich getan. Sie hat mich aus dem Dreck gezogen, als es mir dreckig ging. Sie hat- Sie hat mich wieder aufgebaut und diese Zeit ist vorbei, wissen Sie? Ich habe meine Vergangenheit hinter mir gelassen.'],
    ...
    ['hugo', 'Nein, da ist niemand. Das habe ich Ihnen doch schon gesagt. Aber möglicherweise gibt es jemanden, der etwas sehr Böses wollte und- Ich weiß es doch auch nicht. Finden Sie es doch heraus. Sie muss Gerechtigkeit erfahren. Sie und Elena. Das- Das schulde ich Ihnen.'],
    ...
    ['hugo', 'Nein, es war kein Selbstmord. Dafür war sie viel zu stark. Jeder hier kann das bestätigen. Sie müssen dieses Monster finden, das das getan hat. Es muss- Es muss jemand von da draußen gewesen sein.'],
    ...
    ['hugo', 'Bitte finden Sie den Schuldigen. Ich kann es nicht ertragen, wenn man Ivy einfach so vergisst und ich habe alles verloren. Ich will nur, dass der, der das getan hat, zur Rechenschaft gezogen wird.'],
