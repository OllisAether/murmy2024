...
export const phoebe2: Transcript =  {
  ...
  content: [
    ...
    ['phoebe', textContent(['Na ja, Phineas und ich? Also, wir hatten ', entry({
    ...
    }, 'wenig in der Schule miteinander zu tun gehabt.'), ' Also, ich wüsste nicht, wieso Ivy deswegen eifersüchtig gewesen wäre oder so?'])],
    ...
    ['phoebe', textContent(['Nein, das war es nicht. Phineas war schon immer- Okay, ich gebe zu, wir waren sehr ', entry({
    ...
    }, 'enge Freunde'), '. Wir haben uns immer, ja, nach der Schule getroffen, aber wir haben uns- wir haben nie miteinander geredet oder miteinander gesprochen, aber das hat uns nie wirklich gestört.'])],
    ...
    ['phoebe', textContent(['Ja, so circa 16:15 Uhr und so kurz ', entry({
    ...
    }, 'vor 17 Uhr'), ' war ich bei ihm.'])],
    ['ermittlerin', 'Verstehe. Wie haben Sie sich gefühlt, als Sie erfahren haben, dass Phineas im Krankenhaus liegt?'],
    ['phoebe', textContent(['Es- Es hat mich- Es hat mich einfach zerstört. Wir hatten uns noch an ', entry({
    ...
    ['ermittlerin', textContent(['Sie waren also lange in einem ', entry({
    ...
    }, 'einseitigen Gespräch'), ' mit ihm verwickelt?'])],
