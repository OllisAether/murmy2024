...
export const phoebe2: Transcript =  {
  ...
  content: [
    ...
    ['phoebe', 'Na ja, Phineas und ich? Also, wir hatten wenig in der Schule miteinander zu tun gehabt. Also, ich wüsste nicht, wieso Ivy deswegen eifersüchtig gewesen wäre oder so?'],
    ...
    ['phoebe', 'Na ja, Phineas und ich kannten uns schon lange. Wir sind zusammen aufgewachsen. Also, man könnte uns als, ja, Kindheitsfreund oder so bezeichnen. Vielleicht hat Ivy davon erfahren und sich dann, ja, bedroht gefühlt. Aber das ist irrational. Zwischen uns lief nie etwas. Also nicht so, wie Ivy vielleicht dachte.'],
    ...
    ['phoebe', 'Nein, das war es nicht. Phineas war schon immer- Okay, ich gebe zu, wir waren sehr enge Freunde. Wir haben uns immer, ja, nach der Schule getroffen, aber wir haben uns- wir haben nie miteinander geredet oder miteinander gesprochen, aber das hat uns nie wirklich gestört.'],
    ...
    ['phoebe', 'Phineas und ich hatten einen Streit. Es war einfach kurz vor dem- vor diesem Ganzen. Er hat sich auf einmal verändert. Und er hat mir angefangen, nichts mehr zu erzählen. Und wir haben uns immer weniger gesehen. Und es fühlte sich an, als ob er- als ob er was verheimlichen würde. Und dann kam Ivy ins Spiel.'],
    ['ermittlerin', 'Was meinen Sie damit, wenn Sie sagen, dass Phineas etwas versteckt hat? Warum hatten Sie das Gefühl, Phoebe?'],
    ['phoebe', 'Na ja, es war einfach alles anders. Er wurde plötzlich kälter. Normalerweise hat er mir immer Bescheid gegeben, wenn er zurückziehen musste. Aber- Aber dieses Mal war er einfach distanzierter und- und dann- dann begann Ivy immer präsenter zu werden. Sie kam uns immer näher und es fühlte sich an, als würden sie hinter- über mich reden. Hinter meinem Rücken. Ich- Ich hatte das Gefühl er hat ihr alles erzählt. Ich konnte das einfach nicht mehr ertragen.'],
    ['ermittlerin', 'Welche Dinge hätte Phineas ihr denn erzählen können? Etwas über ihre Vergangenheit?'],
    ['phoebe', 'Ja, also- Ja. Phineas wusste alles über mich. Dinge, die niemand eigentlich wissen sollte. Und plötzlich- plötzlich entfernte er sich von mir. Und dann- dann noch diese Ivy. Ivy kam immer näher und näher. Und ich hatte das Gefühl, sie wüsste einfach alles. Und ich hatte so- so- solche Angst, dass sie einfach alles weiß. Und-'],
    ...
    ['phoebe', 'Ja, so circa 16:15 Uhr und so kurz vor 17 Uhr war ich bei ihm.'],
    ['ermittlerin', 'Verstehe. Wie haben Sie sich gefühlt, als Sie erfahren haben, dass Phineas im Krankenhaus liegt?'],
    ['phoebe', 'Es- Es hat mich- Es hat mich einfach zerstört. Wir hatten uns noch an diesem Morgen noch gestritten und ich konnte einfach nicht aufhören, darüber nachzudenken an unserem letzten Gespräch. Es- Das war so furchtbar und-  und dann- Ich hatte solche Angst, dass ich schuld daran war, dass es meine Schuld einfach war. Dass ich irgendwas Falsches gemacht habe, dass das alles meine Schuld ist.'],
