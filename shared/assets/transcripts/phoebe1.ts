...
export const phoebe1: Transcript =  {
  ...
  content: [
    ...
    },'Also gestern oder? Poah, Donnerstags habe ich immer bis 17 Uhr Schule und um 14 Uhr- Ah ja, da müsste meine Mittagspause gerade vorbei gewesen sein.')],
    ...
    ['phoebe', textContent([entry('phoebe-kenne-ivy-nicht', 'Also, wie schon gesagt, ich kannte sie nicht.'), ' Natürlich ist ihr Tod tragisch. Und vorallem Herr Montague tut mir so unfassbar leid. Wissen Sie, er hat halt seine Frau vor kurzem verloren und jetzt auch noch seine Tochter. Poah, ich kann mir gar nicht vorstellen, wie schrecklich das einfach sein muss. Es tut mir leid einfach, aber-'])],
    ['ermittlerin', 'Sie scheinen Herrn Montague gut zu kennen. Woher wissen Sie denn so viel über ihn?'],
    ['phoebe', 'Na ja, ich kenn mich gut mit den Lehrern. Ich komme gut klar mit denen. Die Sache ist, ich bin halt sehr engagiert in der Schule. Ja, ich bin halt Klassensprecherin und in vielen AGs halt dabei. Und da kriegt man das Ein oder Andere mit. Aber bezüglich Ivy, da weiß ich nicht wirklich viel. Außer, dass sie- Ja, genau. Außer, dass sie halt im Okkult-Club war. Aber von denen halte ich mich fern.'],
    ['ermittlerin', 'Sie sind also sehr aktiv in Ihrem Schulalltag, halten sich aber vom Okkult-Club fern?'],
    ['phoebe', 'Ja, genau. Also dieser Club ist mir einfach nicht so ganz geheuer. Und um ehrlich zu sein, das gehört nicht an eine Schule. Und ja, da sind- passieren so komische Sachen.'],
    ['ermittlerin', 'Was meinen Sie damit? Können Sie das genauer beschreiben?'],
    ['phoebe', textContent(['Ja also. Sie kennen wahrscheinlich so was bei so einem Okkult so passiert, also Rituale und so. Und dann gibt es noch- ja dieses Orakel Zeug. Das ist richtig komisch. Einfach unheimlich. Also normalerweise sage ich immer, die Leute sollen machen, was sie möchten, ',
      entry({
        id: 'phoebe-selbstverteidigung',
        suspectId: 'phoebe',
        title: 'Phoebe habe sich von Ivy verteidigt',
        description: 'Ivy habe Phoebe belästigt und sie habe sich verteidigen müssen.'
      }, 'aber Ivy- Ivy hat mich einfach nicht in Ruhe gelassen. Das lasse ich mir nicht gefallen. Ich musste mich da verteidigen. Verstehen Sie?')])],
    ['ermittlerin', 'Nicht in Ruhe gelassen? Wieso mussten Sie sich verteidigen? Hat Ivy Sie bedroht?'],
    ['phoebe', textContent([entry({
      id: 'phoebe-geheimnis',
      suspectId: 'phoebe',
      title: 'Ivy behauptete, Phoebe habe ein Geheimnis',
    ...
    }, 'Nein nein. Also nicht direkt körperlich oder so. Also, sie kam halt vor ein paar Wochen auf mich zu und sie meinte, sie wüsste von meinem Geheimnis. Also nicht, dass ich eins hätte oder so, nein.'), ' Aber das war so seltsam und sie hat mich einfach genervt damit. Sie haben angefangen, mir Textnachrichten zu schreiben. Richtig viele. Und ich weiß bis heute nicht mal, von wo sie meine Nummer her hat. Mein erster Gedanke war, irgendjemand hat es ihr gegeben, aber wer tut so was?'])],
