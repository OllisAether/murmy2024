...
export const phoebe1: Transcript =  {
  ...
  content: [
    ...
    ['phoebe', textContent(['Also gestern oder? Poah, Donnerstags habe ich immer ', entry({
    ...
    },'bis 17 Uhr Schule'), ' und um 14 Uhr- Ah ja, da müsste meine Mittagspause gerade vorbei gewesen sein.'])],
    ...
    ['phoebe', textContent(['Ja also. Sie kennen wahrscheinlich so was bei so einem Okkult so passiert, also Rituale und so. Und dann gibt es noch- ja dieses Orakel Zeug. Das ist richtig komisch. Einfach unheimlich. Also normalerweise sage ich immer, die Leute sollen machen, was sie möchten, aber Ivy- Ivy hat mich einfach nicht in Ruhe gelassen. Das lasse ich mir nicht gefallen. Ich musste mich da ',
      entry({
    ...
    ['phoebe', textContent(['Nein nein. Also nicht direkt körperlich oder so. Also, sie kam halt vor ein paar Wochen auf mich zu und sie meinte, sie wüsste von ', entry({
      id: 'phoebe-geheimnis',
      suspectId: 'phoebe',
    ...
    }, 'meinem Geheimnis'), '. Also nicht, dass ich eins hätte oder so, nein. Aber das war so seltsam und sie hat mich einfach genervt damit. Sie haben angefangen, mir ', entry({
    ...
    }, 'Textnachrichten zu schreiben'), '. Richtig viele. Und ich weiß bis heute nicht mal, von wo sie meine Nummer her hat. Mein erster Gedanke war, irgendjemand hat es ihr gegeben, aber wer tut so was?'])],
