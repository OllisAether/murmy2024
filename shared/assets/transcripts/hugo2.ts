...
export const hugo2: Transcript =  {
  ...
  content: [
    ...
    ['hugo', textContent(['Das hatte ich Ihnen doch alles schon gesagt. Ich habe ', entry('hugo-holz', 'Holz geholt'), ', bin nach Hause gefahren und anschließend zur ', entry('hugo-orchester', 'Orchesterprobe.')])],
    ...
    ['hugo', textContent(['Ivy und Phineas? ', entry({
    ...
    }, 'Das höre ich zum Ersten Mal'), '. Ich kann mir nicht vorstellen, dass die beiden eine großartige Bindung zusammen hatten und Phineas ist sehr schüchtern und- Ich kann mir nicht vorstellen, dass er etwas mit dem Tod zu tun hat.'])],
    ['ermittlerin', textContent(['Interessant. Uns wurde außerdem mitgeteilt, dass sie im ', entry({
      id: 'hugo-cellokoffer',
      suspectId: 'hugo',
